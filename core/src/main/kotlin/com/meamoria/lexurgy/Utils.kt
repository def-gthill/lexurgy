 ...
 */
fun String.normalizeDecompose(): String = Normalizer.normalize(this, Normalizer.Form.NFD)

/**
 * Performs Unicode normalization to NFC form
 */
fun String.normalizeCompose(): String = Normalizer.normalize(this, Normalizer.Form.NFC)
